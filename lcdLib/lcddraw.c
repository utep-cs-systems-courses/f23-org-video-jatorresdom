...
void draw_ascii() {
    drawString5x7(0, 0 * 7,  "       ---_ ......._-_--.        ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 1 * 7,  "      (|\\ /      / /| \\  \\    ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 2 * 7,  "      /  /     .'  -=-'   `.     ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 3 * 7,  "     /  /    .'             )    ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 4 * 7,  "   _/  /   .'        _.)   /     ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 5 * 7,  "  / o   o        _.-' /  .'      ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 6 * 7,  "  \\          _.-'    / .'*|     ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 7 * 7,  "   \\______.-'//    .'.' \\*|    ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 8 * 7,  "    \\|  \\ | //   .'.' _ |*|    ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 9 * 7, "     `   \\|//  .'.'_ _ _|*|      ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 10 * 7, "      .  .// .'.' | _ _ \\*|     ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 11 * 7, "      \\`-|\\_/ /    \\ _ _ \\*\\", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 12 * 7, "       `/'\\__/      \\ _ _ \\*\\", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 13 * 7, "      /^|            \\ _ _ \\*  ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 14 * 7, "     '  `             \\ _ _ \\  ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 15 * 7, "                       \\_       ", COLOR_GREEN, COLOR_BLACK);
    drawString5x7(0, 16 * 7, "                                                     ", COLOR_GREEN, COLOR_BLACK);
}
